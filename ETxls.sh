...
# This script has 2 important tasks:
#    1. Downloading data from HOBO or CAMPBELL platforms and updating the backend database
#    2. Making forecasts using a machine learning method
...
# record the time/date at the of the daily log file
echo end `date`
